...
export const ROUTES: RouteInfo[] = [
    { path: '/dashboard', title: 'sidebar.home' , icon: 'material-icons' },

    { path: '/pages/timeline', title: 'Timeline Page', icon: 'material-icons' },
    { path: '/pages/user', title: 'User Page', icon: 'material-icons' },

    { path: '/components/buttons', title: 'sidebar.product.products', icon: 'pe-7s-plugin' },
    { path: '/components/grid', title: 'sidebar.product.variant-product', icon: 'pe-7s-plugin' },
